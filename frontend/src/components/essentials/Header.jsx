            ...
            <div>
              <Tooltip title="Mas opciones">
                <button onClick={handleShowMenu}>
                  <KeyboardArrowDownIcon className={`cursor-pointer text-white ${showMenu && "-rotate-180"} transition duration-300 ease-in-out`} size={30} />
                </button>
              </Tooltip>
              {showMenu &&
