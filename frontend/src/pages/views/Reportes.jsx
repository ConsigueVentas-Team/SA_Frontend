  ...
  const generatePDF = async () => {
    ...
    if (isDepart && !isCore) {
      ...
      const usuariosCoreData = apiDataUsuariosSector.map((sector) => [
        { text: sector.profile_name.toUpperCase(), style: "subheader1" },
        {
      ...
      const usuariosSectorData = apiDataUsuariosSector.map((sector) => [
        { text: sector.department_name.toUpperCase(), style: "subheader1" },
        {
        ...
        table: {
          ...
          body: [
            [
              ...
              { text: "Tardanzas", style: "tableHeader", alignment: "center" },
