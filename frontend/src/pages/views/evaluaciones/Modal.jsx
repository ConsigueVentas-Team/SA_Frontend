...
const Modal = ({ isOpen, onClose, idd, nota1, nota2, nota3, nota4, rol }) => {
    ...
    if (rol === 'Colaborador') {
            ...
            <div>
                <div className='mb-4 rounded-lg border border-gray-400 bg-gray-100 px-2 py-1'>
                    <div className='flex items-center'>
                        <label className='w-2/4 text-gray-500'>Habilidades Blandas</label>
                        <input
                            type='number'
                            value={softskills}
                ...
                <div className='mb-4 rounded-lg border border-gray-400 bg-gray-100 px-2 py-1'>
                    <div className='flex items-center'>
                        <label className='w-2/4 text-gray-500'>Habilidades Duras</label>
                        <input
                            type='number'
                            value={hardskills}
        ...
        inputFields = (
            <div className='mb-4 rounded-lg border border-gray-400 bg-gray-100 px-2 py-1'>
                <div className='flex items-center'>
                    <label className='w-2/4 text-gray-500'>Autoevaluacion</label>
                    <input
                        type='number'
    ...
    return (
        ...
        >
            {isSaving ? (
                ...
                <div className='modal mx-auto bg-white p-4 rounded-lg shadow-md' style={{ margin: '50px' }}>
                    <h2 className=' font-bold text-center mb-4'>CARGAR NOTAS</h2>
                    <div className='mb-4 rounded-lg border border-gray-400 bg-gray-100 px-2 py-1'>
                        <div className='flex items-center'>
                            <label className='w-2/4 text-gray-500'>ID:</label>
                            <input type='text' placeholder='ID' value={idd} readOnly className='w-3/4 rounded p-2 ml-2 border border-gray-300' />
                        </div>
                    </div>
                    {inputFields}
                    ...
                    <p className='text-black text-right mb-4'>
                        ...
                        {(
                            ...
                            (rol === 'Colaborador' ? 3 : 1) // Calcular el promedio según el rol
                        ).toFixed(2)}
                    </p>
