...
export const ListItem = ({ user }) => {
  ...
  return (
    <>
      <li className="p-2 py-3 sm:py-4">
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 p-2 text-sm font-semibold duration-300 ease-in-out border rounded-md text-cv-cyan border-cv-secondary hover:bg-cv-secondary sm:text-base active:scale-95"
          >
            <VisibilityIcon />
      ...
      {showCardModal && <CardModal userData={user} close={toggleShowModal} />}
    </>
  );
};
  ...
  return (
    <div>
      <div className="fixed top-0 left-0 z-50 w-screen h-screen overflow-y-auto p-2.5 flex flex-col items-center justify-center bg-cv-secondary/50">
        ...
        <div
          ref={modalRef}
          className="w-full max-w-md overflow-hidden text-white shadow-lg bg-cv-primary rounded-xl shadow-cv-cyan/40"
        >
          <div className="p-4 space-y-4">
            ...
            <div className="space-y-2">
              <BirthdayItem
                name={"Cumpleaños"}
                item={transformDate(userData.birthday)}
              />
              <BirthdayItem
                name={"Departamento"}
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-4">
      ...
      <div>
        ...
        <p className="text-sm font-light text-center text-white truncate">
          {item.email}
        </p>
      </div>
    </div>
...
export const ButtonNavigation = ({ onClick, children }) => {
  return (
    <span
      onClick={onClick}
      className="flex items-center justify-center p-1 text-white duration-300 ease-in-out rounded-full hover:bg-cv-secondary active:scale-95"
    >
      {children}
    </span>
  );
